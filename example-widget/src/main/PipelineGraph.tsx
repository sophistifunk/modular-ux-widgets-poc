...
import { CompositeConnection, decodeResultValue, defaultLayout, LabelInfo, LayoutInfo, MATRIOSKA_PATHS, NodeColumn, NodeInfo, StageInfo } from './PipelineGraphModel';
        ...
        if (stage) {
            ...
            if (children && selectedStage) {
                for (const childStage of children) {
                    let testee:StageInfo | undefined = childStage;
                    while (testee) {
